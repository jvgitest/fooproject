...
/*function sky_theme()
{
   return array(
    'toto' => array(
      ...
      'variables' => array('myvar2'=> 'value_myvar_default'),
    )
  );
}*/

/*function sky_toto($variables) 
{
  
  dsm($variables);
  return "<span style='color:yellow'>".$variables['myvar']." or ".$variables['myvar2']." or ".$variables['myvar3']."</span>";
}*/
/*
function sky_preprocess_toto(&$variables) 
{
  $variables['myvar'] = 'list item 1';
  $variables['myvar2'] = 'list item 2';
  $variables['myvar3'] = 'list item 93';
